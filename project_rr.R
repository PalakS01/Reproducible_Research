...
print(paste("The mean is: ", meanPreNA))print(paste("The median is: ", medianPreNA))
...
plot(stepsPerInterval$meansteps ~ stepsPerInterval$interval,
     ...
     main = "Steps By Time Interval")print(paste("5-Minute Interval containing the most steps on average: ",stepsPerInterval$interval[which.max(stepsPerInterval$meansteps)]))
